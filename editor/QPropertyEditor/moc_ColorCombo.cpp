...
static const char qt_meta_stringdata_ColorCombo[] = {
    "ColorCombo\0\0index\0currentChanged(int)\0"
};
...
const QMetaObjectExtraData ColorCombo::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ColorCombo::staticMetaObject = {
    { &QComboBox::staticMetaObject, qt_meta_stringdata_ColorCombo,
      qt_meta_data_ColorCombo, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ColorCombo::getStaticMetaObject() { return staticMetaObject; }
