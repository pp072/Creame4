...
public:
	enum EventID {
		...
		E_SET_SOUND_FORCE_NO_STREAM, /// If set to true, all following sound nodes will be completly loaded into memory, else, ogg files will be streamed by default, wav files are never streamed
