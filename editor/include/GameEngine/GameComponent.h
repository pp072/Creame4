...
public:
	 ...
	 * 
	 * Used to create a serialized representation of the GameComponent's state by use of a provided GameState object.
	 * Primarily used by GameNetworkManager.
	 * @param state reference to a GameState object provided by caller
	 */
	virtual void	getSerializedState(GameState& state);

	/**
	 * \brief Sets the current GameComponent's state
	 * 
	 * Sets the state of the GameComponent according to the serialized representation within a provided GameState object.
	 * Primarily used by GameNetworkManager.
	 * @param state reference to a GameState object provided by caller
	 */
	virtual void	setSerializedState(GameState& state);
