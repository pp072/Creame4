...
// QDomElement PlugInManager::createRefNode(const QString& name, QWidget* parent /*=0*/)
// {
// // 	QDomElement node;
// // 	QMap<QString, NodeCreateFunc>::const_iterator iter = m_nodeCreateRegistry.find(name);
// //  	if (iter != m_nodeCreateRegistry.end()) _ref_nodeCreateRegistry.insert(name,iter.value());
// }
